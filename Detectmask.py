...
def window1():
    ...
    def about():
        ...
        tk.Label(aboutwin,text = "Dhruvang Gondalia",font=("Arial",18),bg=mycolor,fg='white').place(x = 260,y = 350)
        tk.Label(aboutwin,text = "Omkar Gurav",font=("Arial",18),bg=mycolor,fg='white').place(x = 260,y = 380)
        tk.Label(aboutwin,text = "Ameya Joshi",font=("Arial",18),bg=mycolor,fg='white').place(x = 260,y = 410)
        tk.Label(aboutwin,text = "Aniruddha Joshi",font=("Arial",18),bg=mycolor,fg='white').place(x = 260,y = 440) 
        tk.Label(aboutwin,text = "Under Guidance of Prof. Blessy Varghese",font=("Arial",18),bg=mycolor,fg='white').place(x = 150,y = 490)
